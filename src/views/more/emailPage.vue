        ...
        <div class="main-right">
          ...
          >
            <div style="margin-top: 20px">
              <span style="font-size: 15px; color: black"
                ><span style="color: red">*</span><b>邮件主题格式</b></span
              >
              <br />
              <input
                id="leixing"
            ...
            <br />
            <span style="font-size: 15px; color: black"
              ><span style="color: red">*</span><b>邮件内容描述</b></span
            >
            <div>
              <textarea
                id="questionInput"
            ...
            <div style="margin-top: 20px">
              <span style="font-size: 15px; color: black"
                ><span style="color: red">*</span><b>语气</b></span
              >
              <br />
              <input
                id="yuqi"
            ...
            <div style="margin-top: 20px">
              <span style="font-size: 15px; color: black"
                ><span style="color: red">*</span><b>字数限制</b></span
              >
              <br />
              <input
                id="zishu"
...
.char-response::after {
    content: '';
    border: 10px dashed rgba(130,180,255,.58);
...
.char-response {
    color: black;
    background-color: rgba(130,180,255,.58);
    padding: 15px;
    border-radius: 4px;
    margin: 20px;
    position: relative;
